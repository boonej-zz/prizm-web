    ...
    fetchTrendingTags(users, start, function(err, tags){
      ...
      calculateActivity(users, start, function(err, active){
        ...
        fetchMostPopularPost(users, start, function(err, post){
          ...
          s.popularPost = post;
          fetchNotificationCount(o.owner, start, function(err, c, t){
            console.log('notifications fetched');
            s.notificationCount = c;
            s.notificationTotal = t;
            fetchNotificationCount(o.owner, lastStart, function(err, c, t){
              ...
              mostPopularMessage(o._id, start, function(err, m){
                ...
                s.popularMessage = m;
                fetchMessageCount(o.owner, o._id, users, start, function(err, c, t){
                  console.log('messages fetched');
                  s.messageCount = c;
                  s.messageTotal = t;
                  fetchMessageCount(o.owner, false, users, lastStart, function(err, c){
                    console.log('old messages fetched');
                    s.lastMessageCount = c - s.messageCount;
                    fetchInsightCount(o.owner, start, function(err, c, t){
                      s.insightCount = c;
                      s.insightTotal = t;
                      fetchInsightCount(o.owner, lastStart, function(err, c, t){
